...
import SalaryConfirmModal from "./components/SalaryConfirmModal/SalaryConfirmModal";
  ...
  const closeConfirmModal = () => {
    switch (type) {
      ...
      case "tuitionFee":
        ...
        case "salary":
        return dispatch({
          type: SALARY_MODAL_ACTION_TYPE.CLOSE_CONFIRM_MODAL,
        });
      default:
        return "";
    }
  ...
  return (
    <div className="more-modal">
      <div className="more-modal-con">
        ...
        {type === "salary" && <SalaryConfirmModal/> }
      </div>
    </div>
  );
};
