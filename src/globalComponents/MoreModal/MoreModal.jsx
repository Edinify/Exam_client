...
import RoomsMoreModal from "./components/RoomsMoreModal/RoomsMoreModal";
const MoreModal = ({ setOpenMoreModal, type }) => {
  ...
  const { roomsModalData } = useSelector((state) => state.roomsModal);
  ...
  return (
    <div className="more-modal">
      <div className="more-modal-con">
        ...
        {type ==="rooms"&& <RoomsMoreModal data={roomsModalData} />}
      </div>
    </div>
  );
};
