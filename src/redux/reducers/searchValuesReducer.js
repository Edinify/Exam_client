...
export const searchValuesReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case SEARCH_VALUES_ACTION_TYPES.ROOMS_SEARCH_VALUE:
      ...
      case SEARCH_VALUES_ACTION_TYPES.EXAM_SEARCH_VALUE:
        return{
          ...state,
          examSearchValues:action.payload
        }
        case SEARCH_VALUES_ACTION_TYPES.QUESTION_SEARCH_VALUE:
          return{
            ...state,
            questionSearchValue:action.payload
          }
    default:
      return state;
  }
