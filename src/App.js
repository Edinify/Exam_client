...
import ExamModal from "./globalComponents/Modals/ExamModal/ExamModal";
import QuestionModal from "./globalComponents/Modals/QuestionModal/QuestionModal";
...
function App() {
  ...
  const {examOpenModal} = useSelector(state=>state.examModal)
  const {questionOpenModal } = useSelector(state=>state.questionModal)
  ...
  return (
    <div className="App">
      ...
      {examOpenModal && <ExamModal/>}
      {questionOpenModal && <QuestionModal/>}
